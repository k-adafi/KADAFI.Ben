...
export const translations = {
  fr: {
    ...
    projects: {
      ...
      items: {
        immo: { title: "Site web de l'agence IMMO Mada Océa (terminé)", desc: "Un site web moderne et interactif pour l'agence IMMO Mada Océa à Toamasina, avec gestion des biens et services." },
        mydetector: { title: "My Detector (terminé)", desc: "My DETECTOR est une application de détection et suivi d’objets en temps réel transforme la caméra de votre smartphone en un véritable outil intelligent." },
        ianatra: { title: "Iantra AI (en cours)", desc: "Projet personnel: Application de chatbot AI pour l'éduction secondaire (Lycée et collège)." },
        vente: { title: "Application web de vente (en cours)", desc: "Projet académique: Création de l'application web." },
        educ: { title: "Interface web pour une site d'éducation (en cours)", desc: "Projet académique: Création de plateforme web pour l'éducation secondaire." },
        peace: { title: "Design application PeaceMobile (terminé)", desc: "Design de l'application mobile pour vulgariser les notions de droits et de dignité humaine." },
        jireh: { title: "JirehApk - Application de gestion de clientèle (terminé)", desc: "Application de bureau conçue pour gérer la clientèle de l'entreprise Jireh Students." },
    ...
    experience: {
      ...
      items: {
        dna1: { period: "Février 2026 à aujourd’hui", title: "Développeur full stack", company: "DNA Webhosting (temps partiel)" },
        dna2: { period: "Août 2025 à Janvier 2026", title: "Stagiaire développeur full stack", company: "DNA Webhosting" },
        mission: { period: "Janvier 2025 à Décembre 2025", title: "Freelance développeur en temps partiel", company: "Mission Madagascar" },
  ...
  en: {
    ...
    projects: {
      ...
      goToPage: "Go to page",
      items: {
        immo: { title: "IMMO Mada Océa Agency Website (finished)", desc: "A modern and interactive website for the IMMO Mada Océa agency in Toamasina, with property and service management." },
        mydetector: { title: "My Detector (finished)", desc: "My DETECTOR is a real-time object detection and tracking application that transforms your smartphone camera into a true intelligent tool." },
        ianatra: { title: "Iantra AI (in progress)", desc: "Personal project: AI chatbot application for secondary education (High school and middle school)." },
        vente: { title: "Sales Web Application (in progress)", desc: "Academic project: Creation of a web application." },
        educ: { title: "Web Interface for an Education Site (in progress)", desc: "Academic project: Creation of a web platform for secondary education." },
        peace: { title: "PeaceMobile App Design (finished)", desc: "Mobile app design to popularize the concepts of human rights and dignity." },
        jireh: { title: "JirehApk - Customer Management App (finished)", desc: "Desktop application designed to manage the customer base of the Jireh Students company." },
    ...
    experience: {
      ...
      items: {
        dna1: { period: "February 2026 to Present", title: "Full Stack Developer", company: "DNA Webhosting (part-time)" },
        dna2: { period: "August 2025 to January 2026", title: "Full Stack Developer Intern", company: "DNA Webhosting" },
        mission: { period: "January 2025 to December 2025", title: "Part-time Freelance Developer", company: "Mission Madagascar" },
  ...
  es: {
    ...
    projects: {
      ...
      items: {
        immo: { title: "Sitio web de la agencia IMMO Mada Océa (terminado)", desc: "Un sitio web moderno e interactivo para la agencia IMMO Mada Océa en Toamasina, con gestión de propiedades y servicios." },
        mydetector: { title: "My Detector (terminado)", desc: "My DETECTOR es una aplicación de detección y seguimiento de objetos en tiempo real que transforma la cámara de su teléfono inteligente en una verdadera herramienta inteligente." },
        ianatra: { title: "Iantra AI (en cours)", desc: "Proyecto personal: Aplicación de chatbot de IA para educación secundaria (Secundaria y preparatoria)." },
        vente: { title: "Aplicación web de ventas (en cours)", desc: "Proyecto académico: Creación de una aplicación web." },
        educ: { title: "Interfaz web para un sitio de educación (en cours)", desc: "Proyecto académico: Creación de una plataforma web para la educación secundaria." },
        peace: { title: "Diseño de la aplicación PeaceMobile (terminado)", desc: "Diseño de aplicación móvil para popularizar los conceptos de derechos humanos y dignidad." },
        jireh: { title: "JirehApk - App de Gestión de Clientes (terminado)", desc: "Aplicación de escritorio diseñada para gestionar la base de clientes de la empresa Jireh Students." },
    ...
    experience: {
      ...
      items: {
        dna1: { period: "Febrero 2026 al Presente", title: "Desarrollador Full Stack", company: "DNA Webhosting (tiempo parcial)" },
        dna2: { period: "Agosto 2025 a Enero 2026", title: "Stagiaire Desarrollador Full Stack", company: "DNA Webhosting" },
        mission: { period: "Enero 2025 al Diciembre 2025", title: "Desarrollador Freelance a tiempo parcial", company: "Misión Madagascar" },
